...
if __name__ == "__main__":
    ...
    # for epoch in range(1):
        ...
        for index, images_labels in enumerate(loop):
            ...
            loss_G = options.LAMBDA_GAN_BCE*loss_G_BCE + options.LAMBDA_GAN_L1*loss_G_L1 + options.LAMBDA_RECON*loss_G_reconA + options.LAMBDA_RECON*loss_G_reconB + options.LAMBDA_GDL*loss_G_GDL
            loss_G.backward()
            opt_gen.step()
            # print("gen")
