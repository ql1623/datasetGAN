...
class datasetGAN(nn.Module):
    ...
    def __init__(self,input_channels, output_channels, ngf): # input_channels = 1, output_channel = 1, ngf = 64/32 , features = [16,32,64,128]
        ...
        # decoding path
        self.up1_mod1     = SamplingBlock(self.features*4, self.features*4, down=False, act_fn="relu", norm="batch", use_dropout=True)
        self.upconv1_mod1 = ConvBlock(self.features*4*2, self.features*4, act_fn="relu", norm="batch", use_dropout=True)
        ...
        # decoding path
        self.up1_mod2     = SamplingBlock(self.features*4, self.features*4, down=False, act_fn="relu", norm="batch", use_dropout=True)
        self.upconv1_mod2 = ConvBlock(self.features*4*2, self.features*4, act_fn="relu", norm="batch", use_dropout=True)
